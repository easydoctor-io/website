...
const SecurityConsulting: React.FC = () => {
  return (
    <div className="bg-white dark:bg-eh-dark transition-colors duration-300">
      {/* Hero */}
      <section className="bg-eh-dark dark:bg-black text-white pt-32 pb-20 relative overflow-hidden transition-colors duration-300">
         {/* Abstract Cyber bg */}
      ...
      {/* The Problem Section */}
      <section className="py-20 bg-gray-50 dark:bg-eh-darkSurface/30 border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto mb-16">
                  <h2 className="text-3xl font-bold text-eh-black dark:text-white mb-4">Lo Scenario Attuale: Rischi e Responsabilità</h2>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white dark:bg-eh-darkSurface p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
                      <div className="w-12 h-12 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center mb-6 text-red-600 dark:text-red-400">
                          <AlertOctagon className="h-6 w-6" />
                      </div>
                      <h3 className="text-xl font-bold text-eh-black dark:text-white mb-3">Attacchi Ransomware</h3>
                  ...
                  <div className="bg-white dark:bg-eh-darkSurface p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
                      <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/20 rounded-full flex items-center justify-center mb-6 text-orange-600 dark:text-orange-400">
                          <FileText className="h-6 w-6" />
                      </div>
                      <h3 className="text-xl font-bold text-eh-black dark:text-white mb-3">Sanzioni GDPR</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <div className="bg-white dark:bg-eh-darkSurface p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
                      <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mb-6 text-blue-600 dark:text-blue-400">
                          <Globe className="h-6 w-6" />
                      </div>
                      <h3 className="text-xl font-bold text-eh-black dark:text-white mb-3">Nuova Direttiva NIS2</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 bg-white dark:bg-eh-dark transition-colors duration-300">
          <div className="text-center mb-16">
               <h2 className="text-3xl font-bold text-eh-black dark:text-white">La Nostra Risposta: Sicurezza Integrata</h2>
      ...
      {/* Methodology */}
      <section className="bg-gray-50 dark:bg-eh-darkSurface/30 py-20 border-y border-gray-200 dark:border-gray-800 transition-colors duration-300">
          <div className="max-w-4xl mx-auto px-4 text-center">
              <h2 className="text-3xl font-bold text-eh-black dark:text-white mb-12">Il nostro approccio</h2>
              <div className="flex flex-col md:flex-row justify-center items-center gap-8 relative">
                  {/* Connector Line (Desktop) */}
                  <div className="hidden md:block absolute top-1/2 left-10 right-10 h-0.5 bg-gray-300 dark:bg-gray-700 -z-10 transform -translate-y-1/2"></div>

                  <div className="bg-white dark:bg-eh-darkSurface p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 w-64 z-10">
                      <div className="text-4xl font-bold text-eh-petrol/20 dark:text-eh-green/20 mb-2">01</div>
                      <h4 className="font-bold text-eh-black dark:text-white mb-2">Gap Analysis</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Mappatura dei flussi e rilevazione delle vulnerabilità rispetto alle norme.</p>
                  </div>

                  <div className="bg-white dark:bg-eh-darkSurface p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 w-64 z-10">
                      <div className="text-4xl font-bold text-eh-petrol/20 dark:text-eh-green/20 mb-2">02</div>
                      <h4 className="font-bold text-eh-black dark:text-white mb-2">Remediation</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Stesura procedure, installazione controlli e formazione del personale.</p>
                  </div>

                  <div className="bg-white dark:bg-eh-darkSurface p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 w-64 z-10">
                      <div className="text-4xl font-bold text-eh-petrol/20 dark:text-eh-green/20 mb-2">03</div>
                      <h4 className="font-bold text-eh-black dark:text-white mb-2">Audit Continuo</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Monitoraggio nel tempo per garantire la conformità costante.</p>
                  </div>
              </div>
          </div>
      </section>
